					...
					<?php echo $prompt_message; ?>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Referrer\'s Email', '*', 'form_field','Enter referrer email here','Referrers_Email');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Referrer\'s Phone', '*', 'form_field','Enter referrer phone here','Referrers_Phone');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Email', '*', 'form_field','Enter email here','Email');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Phone', '', 'form_field','Enter phone here','Phone');
									?>
								</div>
							</div>
							<div class="form_box">
