...
$choices = array('- Please Select -','No, thanks','Yes, by email','Yes, by phone');
?>
<!DOCTYPE html>
<html class="no-js" lang="en-US">
	<head>
		...
		<style>
			[type="radio"]:checked + label, [type="radio"]:not(:checked) + label{padding-left: 40px;}
							...
							<div class="form_box">
								<div class="form_box_col1">
									<div class="group">
										<?php
											// @param field name, class, id and attribute
											$input->checktxt('Free_pickup', 'Yes','Yes, I want free pick-up and delivery of RX.');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->select('Would_you_like_us_to_notify_you_when_your_prescriptions_are_ready', 'form_field', $choices);
										?>
									</div>
								</div>
							</div>
