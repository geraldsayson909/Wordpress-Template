...
$recaptcha_sitekey = '6LdMQ9wZAAAAAO6bybRUDJa-klAGkAUqXHv2ITgK'; // Update it using a working google Site key
$recaptcha_privite = '6LdMQ9wZAAAAADD_k_oHaCq2VKOzodVG0hf6df7s'; // Update it using a working google Privite key
