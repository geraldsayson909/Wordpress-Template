						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masteradio('Has Lincese been suspended, revoked or canceled in the last 3 years?', '', array('Yes','No'));
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masteradio('Have you completed an accident prevention course approved by the mother vehicle department?', '', array('Yes','No'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masteradio('Have you been convicted of a DUI in the part 10 years?', '', array('Yes','No'));
									?>
								</div>
							</div>

							<?php $input->info('Household Information');?>

							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masteradio('Do you own or rent your primary residence?', '', array('Own','Rent'));
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<?php
										// @param label-name, if required
										$input->masteradio('Have you lived here at least 3 years?', '', array('Yes','No'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masterselect('Garage Type', '', 'form_field', $garage);
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masterfield('Garage Capacity', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masterselect('Fire Alarm', '', 'form_field', $fire);
									?>
								</div>
							</div>

							<?php $input->info('Vehicle Information');?>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masterfield('Year', '', 'form_field');
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masterfield('Make (ex. Honda, Toyota)', '', 'form_field');
									?>
								</div>
							</div>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masterfield('Model (ex. Honda Civic)', '', 'form_field','Enter model here');
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masterfield('Vehicle ID # (VIN)', '', 'form_field','Enter VIN here','');
									?>
								</div>
							</div>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param label-name, if required
										$input->masterselect('Ownership Status', '', 'form_field', $ownership_status);
									?>
									<?php
										// @param field name, required, value, id, attrib, rows
										$input->masterfield('Estimated Annual Mileage', '', 'form_field');
									?>
								</div>
							</div>
