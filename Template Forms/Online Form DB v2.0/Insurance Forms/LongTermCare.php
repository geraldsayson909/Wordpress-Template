					...
					<div class = "form_content">
						...
						<div class="form_box">
							<div class="form_box_col2">
								<?php
									...
									$input->masterselect('Tobacco / Nicotine Use', '', 'form_field', $tobacco);
								?>
							</div>
						</div>
						...
						<div class="form_box">
							<div class="form_box_col2">
							  <?php
								// @param field name, required, class, replaceholder, rename, id, attrib
								$input->masteradio('Have you ever been treated for any of the following: <span>(Cancer, High Blood Pressure, Diabetes, Asthma, Immune System Disorder, Depression / Anxiety, Heart Disease, Drug / Alcohol Abuse, Epilepsy, or similar with headth conditions?)</span>', '', array('Male','Female'),'Have been treated of the following: Cancer, High Blood Pressure, Diabetes, Asthma, Immune System Disorder, Depression / Anxiety, Heart Disease, Drug / Alcohol Abuse, Epilepsy, or similar with headth conditions');
								$input->masteradio('Have any of tour immediate family members (parents or siblings) had: <span>cancer, hearth disease, stroke or an aneurism prior to the age of 60?</span>', '', array('Male','Female'),'Have been treated of the following: cancer, hearth disease, stroke or an aneurism prior to the age of 60');
							  ?>
							</div>
						</div>
						...
						<div class="form_box">
							<div class="form_box_col2">
							  <?php
								// @param field name, required, class, replaceholder, rename, id, attrib
								$input->masteradio('Have you been convicted in reckless driving or driving under influence of alcohol or drugs in the last 5 years?', '*', array('Yes','No'),'');
								$input->masterfield('Please list any medications currently prescribed and any health history', '', 'form_field','Enter list here','Any_medications_currently_prescribed');
								?>
							</div>
						</div>
						...
						<div class="form_box">
							<div class="form_box_col2">
							  <?php
								// @param field name, required, class, replaceholder, rename, id, attrib
								$input->masterfield('Coverage Amount', '', 'form_field');
								$input->masterfield('Coverage Length', '', 'form_field');
								?>
							</div>
						</div>
