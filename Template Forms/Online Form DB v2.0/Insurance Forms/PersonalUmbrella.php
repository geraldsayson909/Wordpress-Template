...
$formname = 'Personal Umbrella Form';
						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterselect('Marital Status', '', 'form_field', array('- Please Select -','Single','Married','Divorced','Widowed'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of dwellings you own/occupy', '', 'form_field');
										$input->masterfield('Total unit count of all rental dwellings', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of vehicles owned', '', 'form_field');
										$input->masterfield('Number of company provided autos', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box left">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of watercraft vehicles owned <span>(ex. Poweboats, sailboats, etc.)</span>', '', 'form_field','Enter number of watercraft vehicles here','Number_of_watercraft_vehicles owned');
									?>
								</div>
							</div>
							<div class="clearfix"></div>

							<?php $input->info('Driver Information');?>

							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of drivers in the household', '', 'form_field');
										$input->masterfield('List all ages of all drivers', '', 'form_field');
									?>
								</div>
							</div>

							<?php $input->info('Covertage Requested/Desired');?>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterselect('Limit of Coverage', '', 'form_field', array('- Please Select -','$1 Million','$2 Million','$3 Million','$4 Million','$5 Million'));
										$input->masterselect('Underlying Rental Dwelling Limits', '', 'form_field',array('- Please Select -','$100,000','$200,000','$300,000','$400,000','$500,000','$600,000','$700,000','$800,000','$900,000','$1,000,000'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterselect('Underlying Homeowners Limts', '', 'form_field', array('- Please Select -','$100,000','$200,000','$300,000','$400,000','$500,000','$600,000','$700,000','$800,000','$900,000','$1,000,000'));
										$input->masterselect('Underlying Rental Dwelling Limits', '', 'form_field',array('- Please Select -','$100,000','$200,000','$300,000','$400,000','$500,000','$600,000','$700,000','$800,000','$900,000','$1,000,000'));
									?>
								</div>
							</div>
