...
$Best_way = array('- Please Select -','Select','Phone','Fax','Email');
				...
				<div class = "form_frame_b">
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							...
							$input->masterselect('Best way to contact', '', 'form_field', $Best_way);
						  ?>
						</div>
					</div><hr/>
					...
					<div class="form_box">
						...
						<?php
							...
							$input->masterdatepicker('Current Policy Expiration Date', '', 'form_field');
						?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('RV - Year', '', 'form_field');
							$input->masterfield('RV - Make', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('RV - Model', '', 'form_field');
							$input->masterfield('Serial Number of RV', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('RV - Length <span>(in feet)</span>', '', 'form_field','Enter rv - length here','RV-lenght');
							$input->masterfield('Current RV Value', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Year of Engine One', '', 'form_field');
							$input->masterfield('RV - Purchase Price', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Engine size <span>(Horsepower)</span>', '', 'form_field','Enter engine size','Engine_Size');
							$input->masterfield('Location RV', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Years of Engine Two', '', 'form_field','Enter engine size','Engine_Size');
							$input->masterfield('Primary Stored', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
							<div class="form_box_col1">
							  <?php
								// @param field name, required, class, replaceholder, rename, id, attrib
								$input->masterfield('Engine Two size', '', 'form_field','Enter engine size','Engine_Size');
							  ?>
							</div>
							<div class="form_box_col2">
							  <?php
								// @param field name, required, class, replaceholder, rename, id, attrib
								$input->masterfield('Stored A float', '', 'form_field','Enter engine size','Engine_Size');
								$input->masterfield('Range of Navigation', '', 'form_field');
							  ?>
							</div>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Trailor Year', '', 'form_field','Enter engine size','Engine_Size');
							$input->masterfield('Trailor Model', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Trailor Make', '', 'form_field','Enter engine size','Engine_Size');
							$input->masterfield('Trailor Current Value', '', 'form_field');
						  ?>
						</div>
					</div>


					<div class="form_box headingbox">
						<div class="form_box_col2">
							...
							<div class="form_head">
								...
								<div class="form_box">
									<div class="form_box_col2">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Name of Driver', '', 'form_field');
										$input->masterfield('Last Name', '', 'form_field');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterdatepicker('Birth Date', '', 'form_field');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
									...
									<div class="form_box_col2">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Years RV Ownership', '', 'form_field');
										$input->masterfield('Years RVing Experience', '', 'form_field');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Have any operators completed a RVing safety course', '','form_field');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Describe all marine insurance loses', '','form_field');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Drive\'s Lincense Number', '','form_field');
									  ?>
									</div>
								</div>
							</div>
							...
							<div class="form_head">
								...
								<div class="form_box">
									<div class="form_box_col2">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Name of Driver_', '', 'form_field','Enter name of driver');
										$input->masterfield('Last Name_', '', 'form_field', 'Enter last name');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterdatepicker('Birth Date_', '', 'form_field', 'Enter birth date');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
									...
									<div class="form_box_col2">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Years RV Ownership_', '', 'form_field','Enter years rv ownership');
										$input->masterfield('Years RVing Experience_', '', 'form_field', 'Enter years rving experience');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Have any operators completed a RVing safety course_', '','form_field', 'Enter any operators completed a rving safety course');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Describe all marine insurance loses_', '','form_field','Enter all marine insuracance loses');
									  ?>
									</div>
									<div class="form_box_col1">
									  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Driver\'s Lincense Number_', '','form_field','Enter driver\'s license number');
									  ?>
									</div>
								</div>
							</div>
					...
					<?php $input->info('Coverage Request');?>

					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Liability Limit', '', 'form_field','Enter engine size','Engine_Size');
					...
					<div class="form_box">
						<div class="form_box_col2">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Medical Payment', '', 'form_field','Enter engine size','Engine_Size');
							$input->masterfield('Collision Deductible', '', 'form_field');
						  ?>
						</div>
					</div>
					...
					<div class="form_box left">
						<div class="form_box_col1">
						  <?php
							// @param field name, required, class, replaceholder, rename, id, attrib
							$input->masterfield('Comprehensive Deductible', '', 'form_field','Enter engine size','Engine_Size');
						  ?>
						</div>
					</div>
