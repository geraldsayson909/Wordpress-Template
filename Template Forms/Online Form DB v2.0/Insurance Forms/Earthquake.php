						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('No. of claims (in last 3 years)', '', 'form_field','Enter medical payments here');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->mastertextarea('Additional Information (Please include any losses for the last 5 years)', '', 'form_field');
									?>
								</div>
							</div>
