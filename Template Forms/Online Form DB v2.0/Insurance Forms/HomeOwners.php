						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masteradio('Do you own or Rent this property?', '', array('Yes','No'));
										$input->masteradio('Do you live in this property?', '', array('Yes','No'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('Property apt/unit', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Property City', '', 'form_field');
										$input->masterselect('Property State', '', 'form_field', $state );
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Property Zip Code', '', 'form_field');
										$input->masterselect('Construction Type', '', 'form_field', $construction_type );
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterselect('Primary Heating System', '', 'form_field', $primary_heating);
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterselect('Garage Type', '', 'form_field', $garage_type);
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<div class="form_box_col2">
										<?php
											// @param field name, required, class, replaceholder, rename, id, attrib
											$input->masterselect('Security System', '', 'form_field', $security_system );
											$input->masterselect('Fire Alarm', '', 'form_field', $fire_alarm );
										?>
									</div>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masteradio('Select Any Additional Property Features That Apply <span>(optional)</span>', '', array('Dead Bolts','Fire Extinguisher', 'Trampoline', 'Covered Deck/Patio', 'Swimming Pool'),'','','',5);
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Liability Limits', '', 'form_field');
										$input->masterfield('Deductible', '', 'form_field');
									?>
								</div>
							</div>
