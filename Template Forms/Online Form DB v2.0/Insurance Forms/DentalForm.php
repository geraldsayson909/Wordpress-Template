						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterselect('Tobacco/Nicotine Use', '', 'form_field', array('Please select','Never', 'Current User', 'Within past year', 'Over 1 year ago','Over 2 years ago','Over 3years ago','Over 4 years ago','Over 5 years ago'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->mastertextarea('Please list any medications currently prescribed and any health history', '', 'form_field','Enter list any medication currently prescribed and any health history here','List_any_medications');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('First Name', '', 'form_field','','First_Name_');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Last Name', '', 'form_field','','Last_Name_');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterdatepicker('Date of Birth___', '', 'form_field','Enter date of birth here');
									?>
								</div>
							</div>

							<?php $input->info('Dependent Information');?>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of children to be covered', '', 'form_field','','Last_Name_');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
