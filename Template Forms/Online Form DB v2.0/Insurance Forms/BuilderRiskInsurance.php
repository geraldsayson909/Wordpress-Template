...
$formname = 'Builder Risk Insurance Form';
			...
			<div id = "contact_us_form_1" class = "template_form">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('Contact First Name', '*', 'form_field');
              ...
              <div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Address of Property', '*', 'form_field');
              ...
              <div class="form_box">
								<div class="form_box_col2">
									...
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterselect('Best way to contact', '', 'form_field', $best_time);
									?>
								</div>
							</div>
              ...
              <div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
                    $owner = array('Home Owner','Builder','General Contractor');
										$input->masterselect('Are you the Home Owner, a Builder, or General Contractor', '', 'form_field', $owner);
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masteradio('New Construction or Remodel','',array('New Construction','Remodel'));
									?>
								</div>
							</div>
              ...
              <div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masteradio('Residential or Commercial','',array('Residential','Commercial'));
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masterfield('How long will the project last', '', 'form_field','Enter estimated schedule here');
									?>
								</div>
							</div>
				...
				<div class="form_box">
					<div class="form_box_col2">
						<?php
							// @param field name, required, class, replaceholder, rename, id, attrib, value
						$input->masterfield('What will be total value of the complete project', '', 'form_field','Enter estimated schedule here','','Total_Value_of_the_complete_project');

							// @param field name, required, class, replaceholder, rename, id, attrib, value
						$input->masteradio('Construction Type','',array('CBS','Frame'));
						?>
					</div>
				</div>
              ...
              <div class="form_box">
                <div class="form_box_col2">
                  <?php
                    // @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masterfield('What is the value of Builing materials left on the job sight at any time?', '', 'form_field','Enter value here');
                  ?>
                  <?php
                    $policy = array('3 months','6 months','1 year');
                    // @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masterselect('Policy Period', '', 'form_field', $policy);
                  ?>
                </div>
              </div>
              ...
              <div class="form_box">
                <div class="form_box_col1">
                  <?php
                    $deductible = array('1000','2000','3000','4000','5000','10000');
                    // @param field name, required, class, replaceholder, rename, id, attrib, value
              ...
              <div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masteradio('Do you want Hurricane coverage?','',array('Yes','No'));
									?>
                  <?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
                    $input->masteradio('Do you want Liability insurance for the project?','',array('Yes','No'));
									?>
								</div>
							</div>
