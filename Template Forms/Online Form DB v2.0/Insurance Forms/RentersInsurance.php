						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
								...
								<div class="form_box_col2">
									<div class="form_box_col2">
										<?php
											...
											$input->masterfield('Year Built', '', 'form_field');
										?>
									</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('No. of Stories', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
								  <?php
									// @param field name, required, class, replaceholder, rename, id, attrib
									$input->masteradio('Gated Community', '', array('Yes','No'));
							...
							<div class="form_box">
								<div class="form_box_col2">
								  <?php
									// @param field name, required, class, replaceholder, rename, id, attrib
									$input->masterfield('Sq. Footage of Residence', '', 'form_field');
							...
							<div class="form_box">
								<div class="form_box_col2">
								  <?php
									...
									$input->masterfield('Breed of Dog if any', '', 'form_field');
								  ?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Electrical', '', 'form_field');
										$input->masterfield('Age of System', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Plumbing', '', 'form_field');
										$input->masterfield('Age of System', '', 'form_field','Age_of_System_');
									?>
								</div>
							</div>
