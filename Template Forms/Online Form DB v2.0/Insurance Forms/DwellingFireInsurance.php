						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
								  ...
								  <div class="form_box">
									 ...
									 <div class="form_box">
										<div class="form_box_col1">
										  <?php
											// @param field name, required, class, replaceholder, rename, id, attrib
											$input->masteradio('Swimming Pool', '', array('Male','Female'));
										  ?>
										</div>
									</div>
								</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
								  <?php
									// @param field name, required, class, replaceholder, rename, id, attrib
									$input->masterselect('Alarm System', '', 'form_field', $liability);
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->mastertextarea('Additional Information (Please include any losses for the last 5 years)', '', 'form_field','Enter addition information here', 'Additional_Information');
									?>
								</div>
							</div>
