...
$formname = 'General Liability Form';
				...
				<div class = "form_frame_b">
					<div class = "form_content">
						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="infobox">
									<div class="input textarea" ><input type="hidden" value=":" name="Protect your business from large amounts of liability claims for property damage and injuries with the proper General Liability Insurance. Fill out the online form below as completely as possible. Our agents will get back to you for quote."/>
									Protect your business from large amounts of liability claims for property damage and injuries with the proper General Liability Insurance.<br/> Fill out the online form below as completely as possible. Our agents will get back to you for quote.
									</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Contact Number', '*', 'form_field');
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('Zipcode', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number Years Insured', '', 'form_field');
							...
							<div class="form_box">
								<div class="form_box_col">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->mastertextarea('Description of Business Operations', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield("Contractor's License Number", '', 'form_field');
										$input->masterfield('Year Establish', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of Office Location', '', 'form_field');
										$input->masterfield('Number Employees', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Contractors Equipment', '', 'form_field');
										$input->masterfield('Business Personal Property (Content) Total Value', '', 'form_field','Enter Here');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										$input->masterfield('Annual Employee Payroll', '', 'form_field','Enter Here');
									?>
								</div>
							</div>
							...
							<div class="form_box left">
								<div class="form_box_col">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterselect('Insurance Limit Requested', '', 'form_field', $insurance);
									?>
								</div>
							</div>
							<div class="clear"></div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Number of Owners', '', 'form_field');
										$input->masterfield('Percentage of subcontracted work', '', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib
										$input->masterfield('Do you need an excess liability policy', '', 'form_field');
										$input->masterselect('What limits of excess liability', '', 'form_field', $limits);
									?>
								</div>
							</div>
