...
if ($_POST){
	...
	if( empty($_POST['First_Name']) ||
		...
		empty($_POST['Evening_Telephone']) ||
		empty($_POST['Best_time_to_reach_you']) ||
		empty($_POST['Address']) ||
		empty($_POST['City']) ||
		empty($_POST['State']) ||
		empty($_POST['Zip']) ||
						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										...
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Daytime Telephone', '*', 'form_field');
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Evening Telephone', '*', 'form_field');
										$input->masterselect('Best time to reach you', '*', 'form_field', $best_time);
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, options, id, attribute
										$input->mastertextarea('Any Comments or Questions?', '', 'form_field');
									?>
								</div>
							</div>
...
$(document).ready(function() {
	...
	$("#submitform").validate({
		rules: {
			...
			Evening_Telephone: "required",
			Best_time_to_reach_you: "required",
			Address: "required",
			City: "required",
			State: "required",
			Zip: "required",
