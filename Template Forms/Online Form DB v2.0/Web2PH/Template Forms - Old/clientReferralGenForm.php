					...
					<?php echo $prompt_message; ?>
								...
								<div class="form_box_col2">
									<div class="group">
										<?php
											...
											$input->phoneInput('Referrers_Email', 'form_field','Referrers_Email','placeholder="Enter referrer\'s email here here"');
										?>
									</div>
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Referrers_Phone', 'form_field','Referrers_Phone','placeholder="Enter referrer\'s phone here  here"');
										?>
									</div>
								</div>
							</div>
							<div class="form_box">
								<div class="form_box_col1">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masteradio('Contact Preference','',array('Contact by email','Contact by phone'));
									?>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Address 2', '', 'form_field','Enter address 2 here','Address_2');
									?>
								...
								<div class="group">
									...
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Phone Number', 'form_field','Phone Number','placeholder="Enter phone number here"');
										?>
									</div>
								</div>
							</div>
							<div class="form_box">
								<div class="form_box_col2">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Mobile', '', 'form_field','Enter mobile here','Mobile');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
