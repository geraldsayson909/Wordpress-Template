...
class FormsClass {
	...
	function radio($name='',$value='',$id='',$attrib='',$rows=''){
		...
		$style = " style='width: 16.64%;'";
		}else if($rows == 7){
		$style = " style='width: 14.1%;'";
		}
	...
	function phoneInput($name='',$class='',$id='',$attrib='') {
		...
		$value = '';
		$input = '';
		$trigger = '<div class="phone-trigger"><i class="ph flag" data-flag="true"></i></div>';
		$input .= '<div class="field_holder animated_box">'.$trigger.'<input type="text" name="'.$fldname.'" class="'.$class.' cphone" id="'.$id.'" placeholder="+63 (phone number)"><span class = "animated_class"></span></div>';
		echo $input;
	}
