...
<html class="no-js" lang="en-US">
	<head>
		...
		<style>
			.strong_head {margin: 10px auto 12px !important;background: #dfc7cc;padding: 10px;border-radius: 5px;color: #000;text-align: center;}
			.information, .information2 {position: relative;padding: 18px 18px 18px 70px;background: #f3f3f3;border-radius: 10px;color: #333;margin: 10px 0 0 0;}
			.forfont {margin: 10px auto 12px !important;background: #f1f1f1;padding: 10px;border-radius: 5px;color: #000;text-transform: uppercase;font-weight: bold;}
			
			@media only screen and (max-width : 780px) {
				.strong_head{margin-top: 20px !important;}
				.information, .information2 {padding: 18px 18px !important;}
			}
		</style>
	</head>
<body>
			...
			<div id = "contact_us_form_1" class = "template_form">
				<div class = "form_frame_b">
					...
					<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
						...
						<div class="form_box">
							<p class="strong_head" >Child's Information</p><input type="hidden" name="Childs_Information" value=":" />
						</div>
						...
						<div class="form_box">
							<p class="strong_head" >Parent/Guardian's Information</p><input type="hidden" name="Parent/Guardian_Information" value=":" />
						</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->fields('Hospital_Preference', 'form_field','Hospital_Preference','placeholder="Enter hospital preferencehere"');
										?>
									</div>
								</div>
							</div>
