...
if ($_POST){
	if(empty($_POST['Full_Name']) ||
		empty($_POST['Address']) ||
		empty($_POST['City_or_Municipality_']) ||
								...
								<div class="form_box_col2">
									...
									<div class="group">
										<?php
											$input->label('Phone Number', '*');
											// @param field name, class, id and attribute
											$input->phoneInput('Person_to_contact_Phone_Number', 'form_field','Person_to_contact_Phone_Number','placeholder="Enter phone number here"');
										?>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
	...
	$("#submitform").validate({
		rules: {
			Full_Name: "required",
			Address: "required",
			City_or_Municipality_: "required",
