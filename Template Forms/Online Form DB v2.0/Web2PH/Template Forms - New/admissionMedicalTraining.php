								...
								<div class="form_box_col2">
									...
									<div class="group">
										<?php
											$input->label('Phone', '*');
											// @param field name, class, id and attribute
											$input->phoneInput('Phone', 'form_field','Phone','placeholder="Enter number here"');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->fields('School_Last_Attended', 'form_field','School_Last_Attended','placeholder="Enter school attended here"');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col2">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->fields('Graduation_Date', 'form_field Date','Graduation_Date','placeholder="Enter date here"');
										?>
									</div>
									<div class="group">
										<?php
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->textarea('Additional_Information', 'form_field','Additional_Information','placeholder="Enter additional information here"');
										?>
									</div>
								</div>
							</div>
