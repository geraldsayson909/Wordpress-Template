					...
					<?php echo $prompt_message; ?>
							<div class="form_box">
								...
								<div class="form_box_col2">
									...
									<div class="group">
										<?php
											// @param label-name, if required
											$input->label('Type of Inquiry');
											// @param field name, class, id and attribute
											$input->radio('Type_of_Inquiry',array('General Inquiry','Job Request','Other'),'Type_of_Inquiry');
										?>
									</div>
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
									// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->mastertextarea('Brief Description of Your Inquiry', '', 'form_field','Enter brief description of your inquiry here','Brief_Description_of_Your_Inquiry');
									?>
								</div>
							</div>
