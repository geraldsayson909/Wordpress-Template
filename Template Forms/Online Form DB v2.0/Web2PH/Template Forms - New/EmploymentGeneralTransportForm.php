...
$formname = 'Employment General Transport Form';
						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col2">
									...
									?>
									<?php
										// @param field name, required, class, replaceholder, id, attrib, value
										$input->masteradio('Have you had previous experience in the Transportation Field?','',array('Yes','No'));
									?>
								</div>
							</div>
