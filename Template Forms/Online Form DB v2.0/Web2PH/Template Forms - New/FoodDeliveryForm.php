						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								...
								<div class="group">
										<?php
											...
											$input->fields('Complete_Address', 'form_field','Complete_Address','placeholder="Enter address here"');
										?>
									</div>
									<div class="group">
										<?php
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->mastertextarea('Orders', '*', 'form_field');
							...
							<div class="form_box">
								<div class="form_box_col1">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->mastertextarea('Additional Note', '', 'form_field');
									?>
								</div>
							</div>
