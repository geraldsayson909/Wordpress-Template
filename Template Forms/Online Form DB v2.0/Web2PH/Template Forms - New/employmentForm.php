								...
								<div class="form_box_col2">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Phone_Day', 'form_field','Phone_Day','placeholder="Enter phone day here"');
										?>
									</div>
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Phone_Evening', 'form_field','Phone_Evening','placeholder="Enter phone evening here"');
										?>
									</div>
								</div>
							</div>
