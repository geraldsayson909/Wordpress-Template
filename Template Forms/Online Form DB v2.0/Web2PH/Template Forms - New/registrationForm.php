						...
						<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form_box">
								<div class="form_box_col3">
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('City/Municipality', '*', 'form_field','Enter city/municipality here','City_or_Municipality');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
										$input->masterfield('Province', '*', 'form_field','Enter province here','Province');
									?>
									<?php
										// @param field name, required, class, replaceholder, rename, id, attrib, value
