								...
								<div class="form_box_col2">
									...
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Primary_Phone_Number', 'form_field','Primary_Phone_Number','placeholder="Enter primary phone number here"');
										?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->phoneInput('Client_Primary_Phone_Number', 'form_field','Client_Primary_Phone_Number','placeholder="Enter client primary phone number here"');
										?>
									</div>
								</div>
							</div>
