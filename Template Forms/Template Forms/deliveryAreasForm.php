								...
								<div class="form_box_col2">
									...
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->fields('Rental_Date', 'form_field Date','Rental_Date','placeholder="Enter rental date here"');
										?>
									</div>
								</div>
							</div>
							...
							<div class="form_box">
								<div class="form_box_col2">
									<div class="group">
											<?php
												// @param label-name, if required
												$input->label('Drop-Off Time', '*');
												// @param field name, class, id and attribute
												$input->select('Drop_Off_Time', 'form_field', $dropoff);
											?>
									</div>
									<div class="group">
											<?php
												...
												// @param field name, class, id and attribute
												$input->select('Pick_Up_Time', 'form_field', $pickup);
											?>
									</div>
								</div>
							</div>
								...
								<div class="form_box_col1">
									<div class="group">
										<?php
											...
											// @param field name, class, id and attribute
											$input->select('When_would_you_like_us_to_pick_up', 'form_field', $day);
										?>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
	...
	$("#submitform").validate({
		...
		messages: {
			...
			Drop_Off_Time:'',
			Pick_Up_Time:'',
			When_would_you_like_us_to_pick_up:'',
			Email_Address: ""
		}
	});
