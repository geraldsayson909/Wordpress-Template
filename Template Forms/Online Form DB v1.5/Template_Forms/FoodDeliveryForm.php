			...
			<form id="submitform" name="contact" method="post" enctype="multipart/form-data" action="">				
				...
				<div class="field">				
					<div class="input f-left">
						<label for="Complete_Address">Complete Address <span>*</span></label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Complete_Address', 'text','Complete_Address','placeholder="Enter complete address here"'); 
						?>	
					</div>	
				...
				<div class="field">	
					<div class="input textarea">	
						<label for="Orders">Orders <span>*</span></label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Orders', '','Orders','placeholder="Enter orders here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
					<div class="input textarea">	
						...
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Additional_Note', '','Additional_Note','placeholder="Enter additional note here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
