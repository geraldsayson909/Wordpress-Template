				...
				<div class="field">		
					...
					<div class="input f-right">
							...
							<?php 
								...
								$input->radio('Type_of_Inquiry',array('General Inquiry','Job Request','Other'));
							?>						
				   </div>						
			     </div>
				<div class="field">	
					<div class="input textarea">	
						<label for="Brief_Description_of_Your_Inquiry">Brief Description of Your Inquiry</label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Brief_Description_of_Your_Inquiry', '','Brief_Description_of_Your_Inquiry','placeholder="Enter brief description of your inquiry here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
