	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" method="post" action="">				
				...
				<div class="field">		
					<div class="input">
						<label for="How_do_you_prefer_to_be_contacted">How do you prefer to be contacted?</label>
						<?php 
							// @param field name, class, id and attribute
				...
				<div class="field">		
					...
					<div class="input f-right">
						<label for="Preferred_dateb">Preferred Date</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Preferred_date', 'text Date','Preferred_date','placeholder="Enter preferred date here"'); 
						?>
					</div>	
				</div>
				<div class="field">		
				...
				<div class="field">	
					<div class="input textarea">	
						...
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Current_Medical_Conditions', '','Current_Medical_Conditions','placeholder="Enter current medical conditions here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
					<div class="input textarea">	
						<label for="Do_you_take_any_Food/Vitamin_supplements?_If_so,_what?">Do you take any Food/Vitamin supplements? If so, what?</label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Do_you_take_any_Food/Vitamin_supplements?_If_so,_what?', '','Do_you_take_any_Food/Vitamin_supplements?_If_so,_what?','placeholder="Enter details here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
					<div class="input textarea">	
						<label for="Do_you_smoke?_If_yes,_how_many_per_day?">Do you smoke? If yes, how many per day?</label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Do_you_smoke?_If_yes,_how_many_per_day?', '','Do_you_smoke?_If_yes,_how_many_per_day?','placeholder="Enter details here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
					<div class="input textarea">	
						<label for="Exercise">Exercise (what types and how often)</label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Exercise', '','Exercise','placeholder="Enter exercise details here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">		
					<div class="input">
						<label class="block" for="How_well_do_you_sleep?">How well do you sleep?</label>
						<?php 
							// @param field name, value, id and attribute
							$input->radio('How_well_do_you_sleep?',array('Good','Average','Restless','Poor'));
						?>
					</div>	
					<div class="input f-right">
						<label for="Average_hours_of_sleep_per_night">Average hours of sleep per night</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Average_hours_of_sleep_per_night', 'text','Average_hours_of_sleep_per_night','placeholder="Enter hours of sleep here"'); 
						?>
					</div>	
				</div>			
				<div class="field">	
