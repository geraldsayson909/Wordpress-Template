			...
			<form id="submitform" name="contact" method="post" action="">				
				...
				<div class="field">
					<div class="input textarea">
						<input type="checkbox" name="Free_pickup" value="Yes"/> Yes, I want free pick-up and delivery of RX.			
					</div>		
				</div>
				<div class="field">				
					<div class="input">
						...
						<?php 
							...
							$input->select('Would_you_like_us_to_notify_you_when_your_prescriptions_are_ready?', 'select',$choices,'');
						?>	
					</div>
				</div>
				<div class="field">	
