...
$(document).ready(function() {
	...
	$('.thisDate').datepick({
		...
		showTrigger: '<img src="images/calender.png" alt="Select date" style="margin-top:-30px; margin-right: 10px; float:right;" />'
	});
});
</script>
</head>
	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" enctype="multipart/form-data" method="post" action="">
				...
				<div class="field">
					<div class="input">
						<label class="block" for="Are_you_willing_to_work_full_-_time?">Are you willing to work full-time?</label>
						<?php
							// @param field name, value, id and attribute
							$input->radio('Are_you_willing_to_work_full_-_time?',array('Yes','No'));
						?>
					</div>
					<div class="input f-right">
						<label class="block" for="Are_you_willing_to_be_scheduled_in_different_shifts?">Are you willing to be scheduled in different shifts?</label>
						<?php
							// @param field name, value, id and attribute
							$input->radio('Are_you_willing_to_be_scheduled_in_different_shifts?',array('Yes','No'));
						?>
					</div>
				</div>
				<div class="field">
					<div class="input">
						<label class="block" for="Do_you_have_a_valid_Driver\'s_License?">Do you have a valid Driver's License?</label>
						<?php
							// @param field name, value, id and attribute
							$input->radio('Do_you_have_a_valid_Driver\'s_License?',array('Yes','No'));
						?>
					</div>
					<div class="input f-right">
				...
				<div class="field">
					<div class="input">
						<label for="What_other_languages_do_you_speak_or_write_besides_English">What other languages do you speak/write besides English?</label>
						<?php
							// @param field name, class, id and attribute
							$input->fields('What_other_languages_do_you_speak_or_write_besides_English', 'text','What_other_languages_do_you_speak_or_write_besides_English','placeholder="Enter other languages here"');
						?>
					</div>
					<div class="input f-right">
						<label for="What_other_languages_do_you_speak_or_write_besides_English">Are you CPR Certified?</label>
						<?php
							// @param field name, class, id and attribute
				...
				<div class="field">
					<div class="input">
						<label for="Previous_experience">Are you trained with First Aid?</label>
						<?php
							// @param field name, class, id and attribute
					...
					<div class="input f-right">
						<label for="Have_you_had previous_experience_in_Emergency_or_Non-Emergency Medical_Transportation?">Have you had previous experience in Emergency or Non-Emergency Medical Transportation? <span style="font-size:10px; font-style:italic;">(Please describe in detail)</label>
						<?php
							// @param field name, class, id and attribute
							$input->textarea('Have_you_had previous_experience_in_Emergency_or_Non-Emergency Medical_Transportation?', '','Have_you_had previous_experience_in_Emergency_or_Non-Emergency Medical_Transportation?','placeholder="Enter your previous experience here" cols="88"');
						?>
					</div>
				</div>
				...
				<div class="field">
					<div class="input">
						...
						<?php
							// @param field name, class, id and attribute
							$input->fields('How_soon_can_you_start?', 'text thisDate','How_soon_can_you_start?','placeholder="Enter date to start here"');
						?>
					</div>
					<div class="input f-right">
