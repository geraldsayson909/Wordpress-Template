...
$(document).ready(function() {
	...
	/* radio toggle */
	$("input[name='Have_you_had_previous_experience_in_the_Transportation_field']").change(function(){
		if($(this).val() == "Yes"){
			$("#Explanation1").fadeIn();
		...
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" enctype="multipart/form-data" method="post" action="">
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="Have_you_had_previous_experience_in_the_Transportation_field">Have you had previous experience in the Transportation field?</label>
						<?php
							// @param field name, class, id and attribute
							$input->radio('Have_you_had_previous_experience_in_the_Transportation_field',array('Yes','No'));
						?>
					</div>
				</div>
				
				<div class="field" id="Explanation1">
					<div class="input textarea">
						<label for="Please_describe_in_detail">Please describe in detail</label>
						<?php
							// @param field name, class, id and attribute
							$input->textarea('Please_describe_in_detail', 'text','Please_describe_in_detail','placeholder="Describe it here"');
						?>
					</div>
				</div>
