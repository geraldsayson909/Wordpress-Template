...
$besttime = array ('- Please Select - ','Mornings','Afternoons','Evening','Weekends','Anytime');
?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" method="post" action="">
				...
				<div class="field">
					<div class="input textarea">
						<label for="ZipCode">Care Recipient Zip / Postal Code <span>*</span></label>
						<?php
							// @param field name, class, id and attribute
							$input->fields('Zip', 'text','Zip','placeholder="Enter zip or postal code here"');
						?>
					</div>
				</div>
				<div class="field">
