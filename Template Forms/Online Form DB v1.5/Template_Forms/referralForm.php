	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" method="post" action="">				
				...
				<div class="field">
					<div class="input">
						<label for="Name_of_Referrer">Name of Referrer <span>*</span></label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Name_of_Referrer', 'text','Name_of_Referrer','placeholder="Enter name of referrer here"'); 
						?>						
					</div>	
				...
				<div class="field">
					<div class="input textarea">
						<div class="input2 center">
							<label for="Name">Name</label>
							<?php 
								// @param field name, class, id and attribute
								$input->fields('Name_1', 'text','Email','placeholder="Enter name here"'); 
								$input->fields('Name_2', 'text','Email','placeholder="Enter name here"'); 
								$input->fields('Name_3', 'text','Email','placeholder="Enter name here"'); 
							?>	
						</div>
						<div class="input2 center">
							...
							<?php 
								// @param field name, class, id and attribute
								$input->fields('Email_1', 'text','Email','placeholder="Enter email here"'); 
								$input->fields('Email_2', 'text','Email','placeholder="Enter email here"'); 
								$input->fields('Email_3', 'text','Email','placeholder="Enter email here"'); 
							?>	
						</div>
						<div class="input2 center">
							...
							<?php 
								// @param field name, class, id and attribute
								$input->fields('Phone_1', 'text','Email','placeholder="Enter phone here"'); 
								$input->fields('Phone_2', 'text','Email','placeholder="Enter phone here"'); 
								$input->fields('Phone_3', 'text','Email','placeholder="Enter phone here"'); 
							?>
						</div>
					</div>
				</div>
