...
$preferredContact = array('- Please Select -','Phone','Fax','Email');
			...
			<form id="submitform" name="contact" method="post" action="">				
				...
				<div class="field">		
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('How_do_you_prefer_to_be_contacted', 'select',$preferredContact);
						?>
					</div>
					<div class="input f-right">
				...
				<div class="field">		
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Best_time_to_call', 'select',$bestTime);
						?>
					</div>
					<div class="input f-right">
				...
				<div class="field">		
					...
					<div class="input f-right">
						<label for="Phone">Desired Payment Type</label>
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Desired_Payment_Type', 'select',$desiredPayment,'desired','onchange="showMe();"'); 
						?>
						<div style="display:none; clear:both" id="provide">
							<?php 
								// @param field name, class, optname, id and attribute
								$input->fields('Please_provide_SSI_number', 'text','Please_provide_SSI_number','style="margin-top:3px;" placeholder="Please provide SSI number"')
							?>
						</div>
					</div>
				</div>
				<div class="field">		
					<div class="input">
						<label for="Best_time_to_call">Please provide patient's condition</label>
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Please_provide_patients_condition', 'select',$patientCondition,'condition','onchange="showMe1();"');
						?>
					</div>
					<div class="input f-right">
						<div style="display:none; clear:both" id="description">
						<label for="Preferred_Date">Please provide description</label>
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Please_provide_description', '','Please_provide_description','placeholder="Enter description here" style="height:60px;" cols="10"'); 
						?>
						</div>
					</div>
				</div>
				<div class="field">	
					<div class="input textarea">	
						...
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Comments', '','Comments','placeholder="Enter comments here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
