...
$formname = 'Request More Information Form';
	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" method="post" action="">				
				...
				<div class="field">	
					<div class="input textarea">	
						<label for="Questions">Write your questions here</label>	
						<?php 
							// @param field name, class, id and attribute
							$input->textarea('Questions', '','Questions','placeholder="Enter your questions here" cols="88"'); 
						?>
					</div>		
				</div>
				<div class="field">	
