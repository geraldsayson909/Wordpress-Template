	...
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" name="contact" enctype="multipart/form-data" method="post" action="">				
				...
				<div class="field">
					<div class="input">
						<label for="RV_Year">RV - Year </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('RV_Year','text','RV_Year','placeholder="Enter RV - year here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="RV_Make">RV - Make </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('RV_Make','text','RV_Make','placeholder="Enter RV - make here"'); 
						?>	
				...
				<div class="field">
					<div class="input">
						<label for="RV_Model">RV - Model </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('RV_Year','text','RV_Year','placeholder="Enter RV - model here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="Serial_Number_of_RV">Serial Number of RV </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Serial_Number_of_RV','text','Serial_Number_of_RV','placeholder="Enter serial number of RV here"'); 
						?>	
				...
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, id and attribute
							$input->fields('RV_Length','text','RV_Length','placeholder="Enter RV - length (in feet) here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="Current_RV_Value">Current RV Value </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Current_RV_Value','text','Current_RV_Value','placeholder="Enter current RV value here"'); 
						?>	
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="RV_purchase_price">RV - purchase price </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('RV_purchase_price','text','RV_purchase_price','placeholder="Enter RV - purchase price here"'); 
						?>	
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="Location_RV">Location RV </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Location_RV','text','Location_RV','placeholder="Enter location RV here"'); 
						?>	
				...
				<div class="field">
					<div class="input">
						<label for="Years_RV_Ownership">Years RV Ownership </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Years_RV_Ownership','text','Years_RV_Ownership','placeholder="Enter years RV ownership here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="Years_RVing_Experience">Years RVing Experience  </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Years_RVing_Experience','text','Years_RVing_Experience','placeholder="Enter years rving experience here"'); 
						?>	
				...
				<div class="field">
					<div class="input textarea">
						<label for="Have_any_operators_completed_a_RVing_safety_course">Have any operators completed a RVing safety course</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Have_any_operators_completed_a_RVing_safety_course','text','Have_any_operators_completed_a_RVing_safety_course','placeholder=""'); 
						?>	
					</div>
				</div>
				<div class="field">
				...
				<div class="field">
					<div class="input">
						<label for="Years_RV_Ownership_">Years RV Ownership </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Years_RV_Ownership_','text','Years_RV_Ownership_','placeholder="Enter years RV ownership here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="Years_RVing_Experience_">Years RVing Experience  </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Years_RVing_Experience_','text','Years_RVing_Experience_','placeholder="Enter years rving experience here"'); 
						?>	
				...
				<div class="field">
					<div class="input textarea">
						<label for="Have_any_operators_completed_a_RVing_safety_course_">Have any operators completed a RVing safety course</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Have_any_operators_completed_a_RVing_safety_course_','text','Have_any_operators_completed_a_RVing_safety_course_','placeholder=""'); 
						?>	
					</div>
				</div>
				<div class="field">
