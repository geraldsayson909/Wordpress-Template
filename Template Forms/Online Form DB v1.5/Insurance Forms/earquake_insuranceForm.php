...
$formname = 'Earthquake Insurance Form';
...
$best_contact = array('Phone','Fax','Email');
				...
				<div class="field">
					...
					<div class="input f-right">
						...
						?>
							...
							<div class="field">
					<div class="input">
						<label for="Any_erosion_in_the_area?">Any erosion in the area?</label>
						<?php 
							// @param field name, class, optname, id and attribute
							$input->radio('Any_erosion_in_the_area?', array('Yes','No')); 
						?>
					</div>
					<div class="input f-right">
						<label for="Nature_of_subsoil">Nature of subsoil</label>
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Nature_of_subsoil', 'select', $subsoil); 
						?>
					</div>
				</div>
				<div class="field">
					<div class="input">
						<label for="Type_of_topography">Type of topography</label>
						<?php 
							// @param field name, class, optname, id and attribute
							$input->radio('Type_of_topography', array('Yes','No')); 
						?>
					</div>
					<div class="input f-right">
