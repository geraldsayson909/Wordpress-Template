...
$formname = 'Offroad Vehicle Insurance Insurance Form';
			...
			<form id="submitform" name="contact" enctype="multipart/form-data" method="post" action="">				
				...
				<div class="field">
					...
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Current_Policy_Expiration_Date','text Date','Current_Policy_Expiration_Date','placeholder="Enter date here"'); 
						?>	
					</div>
				</div>
				<div class="field">
				...
				<div class="field">
					<div class="input">
						<label for="Offroad_Vehicle_Year">Offroad Vehicle - Year </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Offroad_Vehicle_Year','text','Offroad_Vehicle_Year','placeholder="Enter offroad vehicle - year here"'); 
						?>	
						
					</div>
					<div class="input f-right">
						<label for="Offroad_Vehicle_Make">Offroad Vehicle - Make </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Offroad_Vehicle_Make','text','Offroad_Vehicle_Make','placeholder="Enter offroad vehicle - make here"'); 
						?>	
				...
				<div class="field">
					<div class="input">
						<label for="Offroad_Vehicle_Model">Offroad Vehicle - Model </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Offroad_Vehicle_Model','text','Offroad_Vehicle_Model','placeholder="Enter offroad vehicle - model here"'); 
						?>	
				...
				<div class="field">
					<div class="input">
						<label for="Offroad_Vehicle_Length">Offroad Vehicle - Length (in feet) </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Offroad_Vehicle_Length','text','Offroad_Vehicle_Length','placeholder="Enter offroad vehicle - length (in feet) here"'); 
						?>	
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="Offroad_Vehicle_purchase_price">Offroad Vehicle - purchase price </label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Offroad_Vehicle_purchase_price','text','Offroad_Vehicle_purchase_price','placeholder="Enter offroad vehicle - purchase price here"'); 
						?>	
