			...
			<form id="submitform" name="contact" enctype="multipart/form-data" method="post" action="">				
				...
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Drivers_License','text','Drivers_License','placeholder="Enter driver\'s license here"'); 
						?>	
					</div>
					<div class="input f-right">
				...
				<div class="field">
					<div class="input textarea">
						<div style="background:#0044AF; color:#ffffff; font-size:14px; font-weight:bold; padding:3px 10px;">HOUSEHOLD INFORMATION<input type="hidden" name="Household Information" value=":"/></div>					
					</div>
				</div>
				
				<div class="field">
					<div class="input">
						<label for="Do_you_own_or_rent_your_primary_residence">Do you own or rent your primary residence?</label>
						<?php 
							// @param field name, value, id, attribute, rows, class
							$input->radio('Do_you_own_or_rent_your_primary_residence',array('Own','Rent'));
						?>	
					</div>
					<div class="input f-right">
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="Have_you_lived_here_at_least_3_years">Have you lived here at least 3 years?</label>
						<?php 
							// @param field name, value, id, attribute, rows, class
							$input->radio('Have_you_lived_here_at_least_3_years',array('Yes','No'));
						?>	
					</div>
				</div>
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Garage_Type', 'select',$garage); 
						?>
					</div>
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Garage_Capacity','text','Garage_Capacity','placeholder="Enter garage capacity here"'); 
						?>	
					</div>
				</div>
				<div class="field">
					...
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Fire_alarm', 'select',$fire); 
						?>
					</div>
				</div>
				...
				<div class="field">
					<div class="input textarea">
						<div style="background:#0044AF; color:#ffffff; font-size:14px; font-weight:bold; padding:3px 10px;">VEHICLE INFORMATION<input type="hidden" name="Vehicle Information" value=":"/></div>					
					</div>
				</div>
				...
				<div class="field">
					...
					<div class="input f-right">
						<label for="Make">Make (ex. Honda, Toyota)</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Make','text','Make','placeholder="Enter year here"'); 
						?>	
					</div>
				</div>
				<div class="field">
					<div class="input">
						<label for="Model">Model (ex. Honda Civic)</label>
						<?php 
							// @param field name, class, id and attribute
					...
					<div class="input f-right">
						<label for="VIN">Vehicle ID # (VIN)</label>
						<?php 
							// @param field name, class, id and attribute
				...
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Ownership_Status', 'select',$ownership_status); 
						?>
					</div>
					<div class="input f-right">
						<label for="Estimated_Annual_Mileage">Estimated Annual Mileage</label>
						<?php 
							// @param field name, class, id and attribute
							$input->fields('Estimated_Annual_Mileage','text','Estimated_Annual_Mileage','placeholder="Enter estimated annual mileage here"'); 
						?>	
					</div>
				</div>
				...
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Bodily_Injury', 'select',$bodily); 
						?>
					</div>
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Property_Damage', 'select',$property); 
						?>
					</div>
				</div>
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Uninsured_or_Under-insured_Motorist_Bodily_Injury', 'select',$uninsured_bodily); 
						?>
					</div>
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Uninsured_or_Under-insured_Property_Damage', 'select',$uninsured_property); 
						?>
					</div>
				</div>
				<div class="field">
					<div class="input">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Comprehensive_Deductible', 'select',$comprehensive); 
						?>
					</div>
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Collision_Deductible', 'select',$collision); 
						?>
					</div>
				</div>
				<div class="field">
					...
					<div class="input f-right">
						...
						<?php 
							// @param field name, class, optname, id and attribute
							$input->select('Loss_of_Use', 'select',$loss); 
						?>
					</div>
				</div>
				<div class="field">	
