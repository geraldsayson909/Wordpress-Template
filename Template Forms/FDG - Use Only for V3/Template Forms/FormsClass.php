...
class FormsClass {
	...
	function amount($name='',$id='',$attrib='') {
		...
		$input = '<div class="field_holder animated_box"> <i id="icon" class="fas fa-dollar-sign"></i> <input type="text" name="currency-field Amount" class="form_field amount" id="currency-field" pattern="^\\$?(([1-9](\\d*|\\d{0,2}(,\\d{3})*))|0)(\\.\\d{1,2})?$" value="" data-type="currency" placeholder="Enter amount here"><span class = "animated_class" ></span></div>';
