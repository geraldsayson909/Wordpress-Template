 ...
 */
function comment_form( $recaptcha_key = '', $args = array(), $post_id = null) {
	if ( null === $post_id )
		$post_id = get_the_ID();
	...
	$defaults = array(
		...
		'comment_field'        => '
							...
							$("#submit").click(function(){ if(grecaptcha.getResponse() == "") {var $recaptcha = document.querySelector("#g-recaptcha-response"); $recaptcha.setAttribute("required", "required");	$(".g-recaptcha iframe").css({ "border":"1px solid #f25252", "box-shadow":"2px 0px 10px #ff5454"});	}});});	</script><p class="comment-form-comment"><label for="comment">' . _x( 'Comment <span class="required">*</span>', 'noun' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required"></textarea></p>'. '<script src="https://www.google.com/recaptcha/api.js"></script>'.
