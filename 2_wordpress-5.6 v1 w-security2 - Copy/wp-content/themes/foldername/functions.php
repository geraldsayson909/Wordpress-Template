...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Bottom 1 Box1', 'twentyten' ),
		'id' => 'btm1_box1',
		'description' => __( 'The primary widget area', 'twentyten' ),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar( array(
		'name' => __( 'Bottom 1 Box2', 'twentyten' ),
		'id' => 'btm1_box2',
		'description' => __( 'The primary widget area', 'twentyten' ),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar( array(
		'name' => __( 'Bottom 1 Box3', 'twentyten' ),
		'id' => 'btm1_box3',
		'description' => __( 'The primary widget area', 'twentyten' ),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar( array(
		'name' => __( 'Bottom 1 Box4', 'twentyten' ),
		'id' => 'btm1_box4',
		'description' => __( 'The primary widget area', 'twentyten' ),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
...
add_filter('login_errors', create_function('$a', "return 'Incorrect username or password';"));
