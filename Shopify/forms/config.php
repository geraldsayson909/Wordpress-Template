...
define('COMP_EMAIL', 'thewoosahbox@gmail.com'); // clients email
...
define('COMP_NAME', 'The Woosah Box'); // company name
define('MAIL_TYPE', 2); // 1 - html, 2 - txt
define('MAIL_DOMAIN', 'web6.proweaverlinks.com/thewoosahon233'); // company domain
...
if($testform){
	...
	$to_email 	= 'thewoosahbox@gmail.com';
	$cc = '';
	$bcc = '';
}
